 ...
 *
 * Step 3:
 * Replace your NSLog statements with YSDDLog statements according to the severity of the message.
 * 
 * NSLog(@"Fatal error, no dohickey found!"); -> DDLogError(@"Fatal error, no dohickey found!");
 * 
 * YSDDLog works exactly the same as NSLog.
...
NSString *YSDDExtractFileNameWithoutExtension(const char *filePath, BOOL copy);
...
+ (void)log:(BOOL)asynchronous
    message:(YSDDLogMessage *)logMessage;
 ...
 * 
 * This is equivalent to invoking [YSDDLog addLogger:logger withLogLevel:LOG_LEVEL_ALL].
**/
 ...
 * 
 * For example:
 * [YSDDLog addLogger:consoleLogger withLogLevel:LOG_LEVEL_VERBOSE];
 * [YSDDLog addLogger:fileLogger    withLogLevel:LOG_LEVEL_WARN];
 *
...
- (void)logMessage:(YSDDLogMessage *)logMessage;
...
**/
- (NSString *)formatLogMessage:(YSDDLogMessage *)logMessage;
...
@interface YSDDLogMessage : NSObject <NSCopying>
{
...
@interface YSDDAbstractLogger : NSObject <DDLogger>
{
