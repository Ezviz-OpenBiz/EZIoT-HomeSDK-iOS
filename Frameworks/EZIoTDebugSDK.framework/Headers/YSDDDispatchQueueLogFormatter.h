...
**/
@interface YSDDDispatchQueueLogFormatter : NSObject <DDLogFormatter> {
@protected
...
**/
@interface YSDDDispatchQueueLogFormatter (OverridableMethods)

- (NSString *)stringFromDate:(NSDate *)date;
- (NSString *)queueThreadLabelForLogMessage:(YSDDLogMessage *)logMessage;
