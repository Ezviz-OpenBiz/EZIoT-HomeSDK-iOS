...
// or an array of YSDDLogFileInfo objects.
// The YSDDLogFileInfo class is documented below, and provides a handy wrapper that
// gives you easy access to various file attributes such as the creation date or the file size.

@protocol YSDDLogFileManager <NSObject>
@required
...
// Private methods (only to be used by YSDDFileLogger)

- (NSString *)createNewLogFile;

@optional

// Notifications from YSDDFileLogger
...
**/
@interface YSDDLogFileManagerDefault : NSObject <YSDDLogFileManager>
{
...
/* Inherited from YSDDLogFileManager protocol:
...
**/
@interface YSDDLogFileFormatterDefault : NSObject <DDLogFormatter>
{
...
@interface YSDDFileLogger : YSDDAbstractLogger <DDLogger>
{
    __strong id <YSDDLogFileManager> logFileManager;
    
    YSDDLogFileInfo *currentLogFileInfo;
...
- (id)init;
- (instancetype)initWithLogFileManager:(id <YSDDLogFileManager>)logFileManager;
...
/**
 * The YSDDLogFileManager instance can be used to retrieve the list of log files,
 * and configure the maximum number of archived log files to keep.
 * 
 * @see YSDDLogFileManager.maximumNumberOfLogFiles
**/
@property (strong, nonatomic, readonly) id <YSDDLogFileManager> logFileManager;
...
/**
 * YSDDLogFileInfo is a simple class that provides access to various file attributes.
...
**/
@interface YSDDLogFileInfo : NSObject
{
...
- (NSComparisonResult)reverseCompareByCreationDate:(YSDDLogFileInfo *)another;
- (NSComparisonResult)reverseCompareByModificationDate:(YSDDLogFileInfo *)another;
