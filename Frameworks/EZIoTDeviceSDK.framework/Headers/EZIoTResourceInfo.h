...
@class EZIoTVideoQualityInfo,EZIoTCameraVtmInfo,EZIoTPublicKey;
...
@property(nonatomic,strong) NSArray<EZIoTVideoQualityInfo *>         *videoQualityInfos; //视频品质列表
@property(nonatomic,strong) EZIoTCameraVtmInfo                      *vtmInfo;           //通道流媒体信息
//@property(nonatomic,strong)  YSDeviceCloudInfo  *cloudInfo;         //设备云存储信息
...
@interface EZIoTVideoQualityInfo : NSObject
