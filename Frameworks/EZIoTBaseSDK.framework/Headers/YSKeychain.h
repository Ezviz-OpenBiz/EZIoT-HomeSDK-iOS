...
typedef enum {
	/** No error. */
	YSKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	YSKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	YSKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	YSKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	YSKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	YSKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	YSKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	YSKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	YSKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	YSKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	YSKeychainErrorFailedToDecode = errSecDecode
} YSKeychainErrorCode;

extern NSString *const kYSKeychainErrorDomain;

///** Account name. */
//extern NSString *const kYSKeychainAccountKey;
//
///**
...
// */
//extern NSString *const kYSKeychainCreatedAtKey;
//
///** Item class. */
//extern NSString *const kYSKeychainClassKey;
//
///** Item description. */
//extern NSString *const kYSKeychainDescriptionKey;
//
///** Item label. */
//extern NSString *const kYSKeychainLabelKey;
//
///** Time the item was last modified.
// 
// The value will be a string.
// */
//extern NSString *const kYSKeychainLastModifiedKey;
//
///** Where the item was created. */
//extern NSString *const kYSKeychainWhereKey;
...
/**
 ...
 YSKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
...
/**
 ...
 See the `NSString` constants declared in YSKeychain.h for a list of keys that can be used when accessing the
